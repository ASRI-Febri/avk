...
{   
    ...
    {        
        ...
        $this->data['form_title'] = 'Balance Sheet';
        ...
        // BREADCRUMB
        $this->data['breads'] = array('Accounting','Report','Balance Sheet'); 

        // URL
        $this->data['url_create'] = url('ac-rpt-bs/create');
        $this->data['url_search'] = url('ac-rpt-bs-list');           
        $this->data['url_update'] = url('ac-rpt-bs/update/'); 
        $this->data['url_cancel'] = url('ac-rpt-bs'); 
    ...
    { 
        ...
        $this->data['form_desc'] = 'Balance Sheet';

        $this->data['form_remark'] = 'Laporan Balance Sheet berdasarkan periode tanggal awal dan tanggal akhir';
        ...
        {   
            ...
            // URL SAVE
            $this->data['url_show_repoprt'] = url('ac-rpt-bs');

            return view('accounting/rpt_bs_form', $this->data);
        }
        else
        {
    ...
    public function period_report(Request $request)
    {
        ...
        else 
        {
            ...
            // RECORDS
            $this->data['records'] = $this->exec_sp('USP_GL_R_BalanceSheet',$param,'list','sqlsrv');
