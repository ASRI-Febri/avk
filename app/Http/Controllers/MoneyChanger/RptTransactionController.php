...
{   
    ...
    { 
        ...
        $this->data['title'] = 'AVK';
        $this->data['form_title'] = 'Laporan Transaksi Valas';
        $this->data['form_sub_title'] = 'Laporan Transaksi Valas';
        $this->data['form_desc'] = 'Laporan Transaksi Valas';

        $this->data['form_remark'] = 'Laporan Transaksi valas (jual, beli, pembelian stok) 
            berdasarkan cabang, periode tanggal awal dan tanggal akhir';
    ...
    public function period_report(Request $request)
    {
        ...
        else 
        {
            ...
            // REPORT INFORMATION
            $this->data['page_title'] = 'Laporan Transaksi Valas';   
            $this->data['title'] = 'Laporan Transaksi Valas';            
            $this->data['form_title'] = 'Laporan Transaksi Valas';    
