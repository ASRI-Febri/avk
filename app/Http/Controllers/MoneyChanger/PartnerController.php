...
{   
    ...
    {        
        ...
        // BREADCRUMB
        $this->data['breads'] = array('Money Changer','Business Partner'); 

        // URL
        $this->data['url_create'] = url('mc-partner/create');
        $this->data['url_search'] = url('mc-partner-list');           
        $this->data['url_update'] = url('mc-partner/update/'); 
        $this->data['url_cancel'] = url('mc-partner'); 
    ...
    {       
        ...
        // VIEW
        $this->data['view'] = 'money_changer/partner_list';  
    ...
    function show_form($id, $state)
    {
        ...
        // VIEW  
        $this->data['view'] = 'money_changer/partner_form';
        return view($this->data['view'], $this->data);
    }
    ...
    public function save(Request $request)
    {
        ...
        $this->next_url = url('/mc-partner/update');
