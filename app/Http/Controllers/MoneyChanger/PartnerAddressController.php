...
class PartnerAddressController extends MyController
{   
    // =========================================================================================
    // CONSTRUCTOR
    // =========================================================================================
    ...
    {        
        ...
        // URL
        $this->data['url_create'] = url('mc-partner-address/create');
        $this->data['url_search'] = url('mc-partner-address-list');           
        $this->data['url_update'] = url('mc-partner-address/update/'); 
        $this->data['url_cancel'] = url('mc-partner-address'); 
    ...
    {	
        ...
        return view('money_changer/partner_address_list', $this->data);
    }
    ...
    public function create(Request $request)
    {
        ...
        $this->data['form_desc'] = 'Add Partner Address';       
    ...
    public function update($id)
    {
        ...
        $this->data['form_desc'] = 'Update Partner Address';              
    ...
    function show_form($id, $state)
    {
        ...
        $this->data['dd_city_description'] = array('' => 'Cari kota atau kelurahan');         

        // URL
        $this->data['url_save_modal'] = url('/mc-partner-address/save');         

        // VIEW                
        $this->data['view'] = 'money_changer/partner_address_form';
    ...
    public function save(Request $request)
    {
        ...
        $this->next_url = url('/mc-partner-address/reload');
    ...
    public function delete(Request $request)
    {
        ...
        // URL SAVE
        $this->data['url_save_modal'] = url('mc-partner-address/save-delete');

        return view('money_changer/partner_address_delete_form', $this->data);
    }
