...
class VendorBankController extends MyController
{   
    // =========================================================================================
    // CONSTRUCTOR
    // =========================================================================================
    ...
    {        
        ...
        // URL
        $this->data['url_create'] = url('pr-vendor-bank/create');
        $this->data['url_search'] = url('pr-vendor-bank-list');           
        $this->data['url_update'] = url('pr-vendor-bank/update/'); 
        $this->data['url_cancel'] = url('pr-vendor-bank'); 
    ...
    {	
        ...
        return view('procurement/vendor_bank_list', $this->data);
    }
    ...
    public function create(Request $request)
    {
        ...
        $this->data['form_desc'] = 'Add Vendor Bank';       
    ...
    function show_form($id, $state)
    {
        ...
        // URL
        $this->data['url_save_modal'] = url('/pr-vendor-bank/save');         

        // VIEW                
        $this->data['view'] = 'procurement/vendor_bank_form';
    ...
    public function save(Request $request)
    {
        ...
        $this->next_url = url('/pr-vendor-bank/reload');
    ...
    public function delete(Request $request)
    {
        ...
        // URL SAVE
        $this->data['url_save_modal'] = url('pr-vendor-bank/save-delete');

        return view('procurement/vendor_bank_delete_form', $this->data);
    }
