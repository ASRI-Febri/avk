...
{   
    ...
    {        
        ...
        // URL
        $this->data['url_create'] = url('gn-partner-address/create');
        $this->data['url_search'] = url('gn-partner-address-list');           
        $this->data['url_update'] = url('gn-partner-address/update/'); 
        $this->data['url_cancel'] = url('gn-partner-address'); 
    ...
    {	
        ...
        return view('general/partner_address_list', $this->data);
    }
    ...
    function show_form($id, $state)
    {
        ...
        // URL
        $this->data['url_save_modal'] = url('/gn-partner-address/save');         

        // VIEW                
        $this->data['view'] = 'general/partner_address_form';
    ...
    public function save(Request $request)
    {
        ...
        $this->next_url = url('/gn-partner-address/reload');
    ...
    public function delete(Request $request)
    {
        ...
        // URL SAVE
        $this->data['url_save_modal'] = url('gn-partner-address/save-delete');

        return view('general/partner_address_delete_form', $this->data);
    }
