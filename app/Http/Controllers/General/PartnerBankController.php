...
{   
    ...
    {        
        ...
        // URL
        $this->data['url_create'] = url('gn-partner-bank/create');
        $this->data['url_search'] = url('gn-partner-bank-list');           
        $this->data['url_update'] = url('gn-partner-bank/update/'); 
        $this->data['url_cancel'] = url('gn-partner-bank'); 
    ...
    {	
        ...
        return view('general/partner_bank_list', $this->data);
    }
    ...
    function show_form($id, $state)
    {
        ...
        // URL
        $this->data['url_save_modal'] = url('/gn-partner-bank/save');         

        // VIEW                
        $this->data['view'] = 'general/partner_bank_form';
    ...
    public function save(Request $request)
    {
        ...
        $this->next_url = url('/gn-partner-bank/reload');
    ...
    public function delete(Request $request)
    {
        ...
        // URL SAVE
        $this->data['url_save_modal'] = url('gn-partner-bank/save-delete');

        return view('general/partner_bank_delete_form', $this->data);
    }
