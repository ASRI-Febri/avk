...
class FinancialPaymentControllerDetail extends MyController
{   
    // =========================================================================================
    // CONSTRUCTOR
    // =========================================================================================
    ...
    public function reload($id)
    {
        ...
        $this->data['records_detail'] = $this->exec_sp('QualityDB.dbo.USP_CM_FinancialPaymentDetail_List',$param,'list','sqlsrv');
    ...
    public function inquiry_data(Request $request)
    {
        ...
        $this->data['records_detail'] = $this->exec_sp('QualityDB.dbo.USP_CM_SalesInvoiceDetail_List',$param,'list','sqlsrv');
