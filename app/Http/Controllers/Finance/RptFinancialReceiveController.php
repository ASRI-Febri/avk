...
class RptFinancialReceiveController extends MyController
{ 
    // =========================================================================================
    // CONSTRUCTOR
    // =========================================================================================
    ...
    {        
        ...
        $this->data['form_title'] = 'Financial Receive Report';
    ...
    public function financial_receive()
    { 
        $this->data['form_id'] = 'FM-RPT-Financial-Receive';
        ...
        $this->data['form_title'] = 'Laporan Financial Receive';
        $this->data['form_sub_title'] = 'Laporan';
        $this->data['form_desc'] = 'Laporan Financial Receive';

        $this->data['form_remark'] = 'Laporan Financial Receive';

        // BREADCRUMB
        array_push($this->data['breads'],'Financial Receive'); 
        ...
        { 
            ...
            // URL SAVE
            $this->data['url_show_repoprt'] = url('fm-rpt-financial-receive');

            return view('finance/rpt_financial_receive_form', $this->data);
        }
        else
        {
    ...
    public function financial_receive_report(Request $request)
    {
        ...
        else 
        {
            ...
            // REPORT INFORMATION
            $this->data['page_title'] = 'Laporan Financial Receive';   
            $this->data['title'] = 'Laporan Financial Receive';            
            $this->data['form_title'] = 'Laporan Financial Receive';      
            ...
            // RECORDS
            $this->data['records'] = $this->exec_sp('USP_CM_R_FinancialReceive_Period',$param,'list','sqlsrv');

            // VIEW
            $this->data['view'] = 'finance/rpt_financial_receive_report'; 
