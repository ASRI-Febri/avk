...
{   
    ...
    {        
        ...
        // BREADCRUMB
        $this->data['breads'] = array('Finance','Setting','Bank'); 

        // URL
        $this->data['url_create'] = url('fm-bank/create');
        $this->data['url_search'] = url('fm-bank-list');           
        $this->data['url_update'] = url('fm-bank/update/'); 
        $this->data['url_cancel'] = url('fm-bank'); 
    ...
    {       
        ...
        // VIEW
        $this->data['view'] = 'finance/bank_list';  
    ...
    function show_form($id, $state)
    {
        ...
        // URL
        $this->data['url_save_header'] = url('/fm-bank/save');
        ...
        $this->data['view'] = 'finance/bank_form';
        return view($this->data['view'], $this->data);
    }
    ...
    public function save(Request $request)
    {
        ...
        $this->next_url = url('/fm-bank/update');

        if(isset($_POST['add-new-after-save']))
        {
            $this->next_url = url('/fm-bank/create');
        }
