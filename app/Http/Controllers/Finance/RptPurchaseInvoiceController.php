...
class RptPurchaseInvoiceController extends MyController
{ 
    // =========================================================================================
    // CONSTRUCTOR
    // =========================================================================================
    ...
    {        
        ...
        $this->data['form_title'] = 'Purchase Invoice Report';
    ...
    { 
        $this->data['form_id'] = 'FM-RPT-Purchase-Invoice';
        ...
        $this->data['form_title'] = 'Laporan Purchase Invoie';
        $this->data['form_sub_title'] = 'Laporan';
        $this->data['form_desc'] = 'Laporan Purchase Invoie';

        $this->data['form_remark'] = 'Laporan Purchase Invoie';

        // BREADCRUMB
        array_push($this->data['breads'],'Purchase Invoie'); 
        ...
        { 
            ...
            // URL SAVE
            $this->data['url_show_repoprt'] = url('fm-rpt-purchase-invoice');

            return view('finance/rpt_purchase_invoice_form', $this->data);
        }
        else
        {
    ...
    public function purchase_invoice_report(Request $request)
    {
        ...
        else 
        {
            ...
            // REPORT INFORMATION
            $this->data['page_title'] = 'Laporan Purchase Invoie';   
            $this->data['title'] = 'Laporan Purchase Invoie';            
            $this->data['form_title'] = 'Laporan Purchase Invoie';      
            ...
            // RECORDS
            $this->data['records'] = $this->exec_sp('USP_CM_R_PurchaseInvoice_Period',$param,'list','sqlsrv');

            // VIEW
            $this->data['title'] = 'LAPORAN PURCHASE INVOICE';   
            $this->data['view'] = 'finance/rpt_purchase_invoice_report';                                 
