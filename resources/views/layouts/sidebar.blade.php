    ...
    <div data-simplebar class="h-100">
        ...
        <div id="sidebar-menu">
            ...
            <ul class="left-menu list-unstyled" id="side-menu">
                ...
                <li>
                    <a href="{{ url('pw-pawn') }}"><i class="fas fa-pager"></i> <span>Daftar Gadai</span></a>
                </li>

                <li>
                    <a href="{{ url('cf-loan') }}"><i class="fas fa-pager"></i> <span>Daftar Pinjaman</span></a>
                </li>
