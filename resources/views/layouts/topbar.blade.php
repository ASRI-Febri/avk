    ...
    <div class="navbar-header">
        ...
        <div class="navbar-logo-box">
            <a href="{{ url('index') }}" class="logo logo-dark">
                <span class="logo-sm">
                    <img src="{{ URL::asset('assets/images/avk-logo-sm.png') }}" alt="logo-sm-dark" height="20">
                </span>
                <span class="logo-lg">
                    <img src="{{ URL::asset('assets/images/avk-logo.png') }}" alt="logo-dark" height="50">
                </span>
            </a>

            <a href="{{ url('index') }}" class="logo logo-light">
                <span class="logo-sm">
                    <img src="{{ URL::asset('assets/images/avk-logo-sm.png') }}" alt="logo-sm-light" height="20">
                </span>
                <span class="logo-lg">
                    <img src="{{ URL::asset('assets/images/avk-logo.png') }}" alt="logo-light" height="50">
                </span>
            </a>
        ...
        <div class="d-flex justify-content-between menu-sm px-3 ms-auto">
            <div class="d-flex align-items-center gap-2">
                <div class="dropdown d-none d-lg-block">
                    <button type="button" class="btn btn-info btn-sm fs-14 d-inline" data-bs-toggle="dropdown">
                        Modules
                        <i class="mdi mdi-chevron-down align-middle"></i>
                    </button>
                    <div class="dropdown-menu dropdown-menu-start dropdown-menu-animated">
                        <a href="{{ url('money-changer') }}" class="dropdown-item">
                            <div class="dropdown-icon"><i class="fas fa-dollar-sign"></i></div>
                        ...
                        <a href="{{ url('accounting') }}" class="dropdown-item">
                            <div class="dropdown-icon"><i class="far fa-sticky-note"></i></div>
                            <span class="dropdown-content">Accounting</span>                            
                        </a>
                        <a href="{{ url('general') }}" class="dropdown-item">
                            <div class="dropdown-icon"><i class="fas fa-cogs"></i></div>
                            <span class="dropdown-content">Setting & Configuration</span>                            
                        </a>
                        <a href="{{ url('user-management') }}" class="dropdown-item">
                            <div class="dropdown-icon"><i class="far fa-address-card"></i></div>
                            <span class="dropdown-content">User Management</span>                            
                        </a>
                    ...
                    <div
                        ...
                        <div class="dropdown-row justify-content-center">
                            <div class="p-2 menu-image">
                                <img src="{{ URL::asset('assets/images/mega-menu.png') }}" alt="mega-menu image"
            ...
            <div class="d-flex align-items-center gap-2">
                ...
                <div class="dropdown d-inline-block">
                    <button type="button" class="btn btn-sm top-icon p-0" id="page-header-user-dropdown"
                        ...
                        <img class="rounded avatar-2xs p-0" src="{{ URL::asset('assets/images/users/avatar-6.png') }}"
                            alt="Header Avatar">
                    </button>
                    <div
                        ...
                        <div class="card border-0">
                            <div class="card-header bg-primary rounded-0">
                                <div class="rich-list-item w-100 p-0">
                                    ...
                                    <div class="rich-list-content">
                                        <h3 class="rich-list-title text-white">{{ session('user_id') }}</h3>
                                        <span class="rich-list-subtitle text-white">{{ session('user_name') }}</span>
                                    </div>
                            ...
                            <div class="card-footer card-footer-bordered rounded-0"><a href="{{ url('logout') }}"
