    ...
    <div class="row g-3 mb-3">
            ...
            <div class="card border h-100">
                ...
                <div class="card-body">
                    <div class="form-group row mb-2">
                        <label class="col-sm-3 col-form-label text-secondary">Jenis Transaksi</label>
                        <div class="col-sm-9">

                            <x-select-horizontal label="Tipe Transaksi" id="TipeTransaksi" value="" class="required" :array="$dd_tipe"/> 

                            {{-- <select id="TipeTransaksi" name="TipeTransaksi" class="select2 required">
                                <option value="">-- Pilih --</option>
                                @foreach($dd_tipe as $item)
                                    <option value="{{ $item['value'] }}"
                                        {{ ($fields->TipeTransaksi ?? '') == $item['value'] ? 'selected' : '' }}>
                                        {{ $item['text'] }}
                                    </option>
                                @endforeach
                            </select> --}}
                    ...
                    <div class="row mb-2">
                        <label class="col-sm-3 col-form-label text-secondary">Tanggal</label>
                        <div class="col-sm-9">
                            <input type="text" id="TanggalNota" name="TanggalNota"
                    ...
                    <div class="row mb-2">
                        <label class="col-sm-3 col-form-label text-secondary">No. Kwitansi</label>
                        <div class="col-sm-9">
                            <input type="text" id="NoNota" name="NoNota"
                                class="form-control"
                    ...
                    <div class="row mb-2">
                        <label class="col-sm-3 col-form-label text-secondary">Keterangan</label>
                        <div class="col-sm-9">
        ...
        <div class="col-md-6">
            <div class="card border h-100">
                ...
                <div class="card-body">
                    <div class="row mb-2">
                        <label class="col-sm-3 col-form-label text-secondary">Nama</label>
                        <div class="col-sm-9">
                            <input type="text" id="NamaKonsumen" name="NamaKonsumen"
                                class="form-control"
                    ...
                    <div class="row mb-2">
                        <label class="col-sm-3 col-form-label text-secondary">No. KTP / Identitas</label>
                        <div class="col-sm-9">
                    ...
                    <div class="row mb-2">
                        <label class="col-sm-3 col-form-label text-secondary">No. Telp</label>
                        <div class="col-sm-9">
                    ...
                    <div class="row mb-2">
                        <label class="col-sm-3 col-form-label text-secondary">Sumber Dana</label>
                        <div class="col-sm-9">
                    ...
                    <div class="row mb-2">
                        <label class="col-sm-3 col-form-label text-secondary">Tujuan Transaksi</label>
                        <div class="col-sm-9">
                            <input type="text" id="TujuanTransaksi" name="TujuanTransaksi"
                                class="form-control"
                ...
                <table class="table table-bordered table-hover mb-0" id="tbl-detail">
                    <thead class="table-light">
                        <tr>
                            ...
                            <th style="width:140px;" class="text-end">Nilai Tukar (Rate)</th>
