...
@section('modal-content')
        ...
        <div class="row">
            ...
            <div class="col-sm-6"> 
                <div class="row">
                    ...
                    <div class="col-sm-8"><strong>{{ $header->PONumber }}</strong></div> 
                </div>           
            </div>        
        </div>
    </div>
    ...
    <div class="d-grid gap-3">
        ...
        <x-textbox-horizontal label="Tanggal Pembayaran" id="PaymentDate" :value="$fields->PaymentDate" placeholder="" class="required datepicker2" />
        ...
        <x-textbox-horizontal label="Jumlah Pembayaran" id="PaymentAmount" :value="$fields->PaymentAmount" placeholder="" class="required auto" />
