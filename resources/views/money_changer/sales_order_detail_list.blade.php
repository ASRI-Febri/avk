<table class="table table-bordered">
    <thead>
        <tr>
            ...
            <th scope="col" class="text-left">Nilai Transaksi</th>
    ...
    @if($records_detail)
        ...
        @foreach($records_detail as $row)
            ...
            <tr>
                ...
                <td>    
                    <span>Nilai Transaksi :  {{ $row->ForeignCurrencyID . ' ' . number_format($row->ForeignAmount, 2, '.', ',') }}<span>       
                    <br>
                ...
                <td class="text-center">
                    ...
                    <div class="input-group-prepend text-center">
                        <x-btn-edit-detail :id="$row->IDX_T_SalesOrderDetail" />
                        <x-btn-delete-detail :id="$row->IDX_T_SalesOrderDetail" :label="$row->ValasName" function="deleteDetailValas" />                    
                    </div>
                    @endif
                </td>
                @endif
        ...
        <tr class="font-weight-bold">
            <td colspan="5" class="text-end"><strong>Total Base Amount</strong></td>
