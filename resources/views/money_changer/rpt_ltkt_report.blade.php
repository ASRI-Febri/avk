        ...
        <div style="float:left;width:70%;">
            <table>
                <tr>
                    ...
                    <td class="param-value">: {{ $PeriodDesc }} ({{ $LTKTPeriod }})</td>
                </tr>
                <tr>
                    <td class="param-key">KRITERIA</td>
                    <td class="param-value">: Transaksi tunai Rp 500.000.000 ke atas per nasabah per hari</td>
                </tr>
                <tr>
                    <td class="param-key">BATAS LAPOR</td>
                    <td class="param-value">: 14 hari kerja sejak tanggal transaksi</td>
                </tr>
            </table>
        </div>
    </div>
    ...
    <table id="table-report" class="minimalistBlack">
        ...
        @foreach($records as $row)
            ...
            <tr>
                ...
                <td class="text-right">{{ number_format($row->DailyCashAmount,2,'.',',') }}</td>
        ...
        @if($row_number == 0)
            <tr>
                <td colspan="13" class="text-center">
                    Tidak ada data LTKT untuk periode {{ $PeriodDesc }}. Jalankan Proses LTKT terlebih dahulu.
                </td>
            </tr>
        @else
            <tr>
