    ...
    <table id="table-report" class="minimalistBlack">
        ...
        @foreach ($records as $row)
            ...
            @php
                ...
                $purchase_amount += $row->TotalPurchaseAmount;
            ...
            @if($group_a1 <> $group_a2)
                ...
                @if($row_number > 1)
                    <tr>
                        ...
                        <td class="text-right"><strong>{{ number_format($group_purchase_amount,2,'.',',') }}</strong></td>
            ...
            @php 
                ...
                $group_purchase_amount += $row->TotalPurchaseAmount;
            ...
            <tr>
                ...
                <td>
                    <a href="{{ url('mc-purchase-order/update') . '/' . $row->IDX_T_PurchaseOrder }}" target="_blank">{{ $row->TransactionNo }}</a>
                </td>
                <td>{{ $row->ReferenceNo }}</td>
                <td class="text-center">{{ $row->PartnerName }}</td>
                <td>{{ $row->RemarkHeader }}</td>
                <td class="text-right">{{ number_format($row->TotalPurchaseAmount,2,'.',',') }}</td>
        ...
        <tr>
            ...
            <td class="text-right"><strong>{{ number_format($purchase_amount,2,'.',',') }}</strong></td>
