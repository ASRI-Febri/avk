...
@section('content-form')
    ...
    <input type="hidden" id="IDX_M_TransactionType" name="IDX_M_TransactionType" value="{{ $IDX_M_TransactionType }}"/>
    ...
    <div class="d-grid gap-3">
        ...
        {{-- <x-select-horizontal label="Jenis Transaksi (Opsional)" id="IDX_M_TransactionType" :value="$IDX_M_TransactionType" class="" :array="$dd_transaction_type" flag="" /> --}}
