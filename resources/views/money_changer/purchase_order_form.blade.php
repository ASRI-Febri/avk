...
@section('action')
    ...
    <x-btn-action>
        ...
        <a href="{{ url('mc-purchase-order/print-nota-kasir').'/'.$fields->IDX_T_PurchaseOrder }}" id="btn-print-nota-kasir"
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="d-grid gap-3">
                        ...
                        <x-lookup-horizontal label="Beli Dari" id="PartnerDesc" :value="$fields->PartnerDesc" class="required"
...
@section('script')
    ...
    <script>
        ...
        var stockCardReloadUrl = "{{ url('mc-stock-card-check/reload/3') }}" + '/' + {{ $fields->IDX_T_PurchaseOrder }};
