...
@section('content_form')  
    ...
    <input type="hidden" id="COASales" name="COASales" value="{{ $fields->COASales }}"/>  
    ...
    <hr>
    <x-textbox-horizontal label="Branch Remark" id="BranchRemark" :value="$fields->BranchRemark" placeholder="" class="" /> 
    <x-lookup-horizontal label="CoA Sales" id="COASalesDesc" :value="$fields->COASalesDesc" class="required"  button="btn-find-coa"/>  
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#btn-find-coa').click(function(){
                ...
                var data = {
                    _token: $("#_token").val(),  
                    target_index: 'COASales',
                    target_name: 'COASalesDesc'                  
                }              
