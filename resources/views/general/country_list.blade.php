    ...
    <div class="row mb-3">
        <div class="col-4">
            <div class="input-group">
                <span class="input-group-text" id="inputGroup-sizing-default">Kode Negara</span> 
...
@section('datatables_array')
    columns: [
        ...
        { data: "IDX_M_Country", visible: false },
        { data: "CountryID", visible: true },
        ...
        { data: "StatusDesc", render: 
            function( data, type, row )
            {	 
                var url_update = '{{ $url_update }}' + '/' + row['IDX_M_Country'];
