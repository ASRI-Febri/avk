...
@section('datatables_array')
    ...
    columns: [
        ...
        { data: "IDX_M_Group", visible: false }, 
        { data: "GroupID" },
        { data: "GroupName" },
        ...
        { "render": 	function ( data, type, row ){						  
                    var select = '<input type="checkbox" class="ids" id="chk_box[]" name="chk_box[]" value="' + row['IDX_M_Group'] + '">';									
                    return select;
                },
            "sClass": "text-center"
        },	 
...
@section('button')
    ...
    <x-btn-save-detail id="btn-save-detail" label="Select and Save" :url="$url_save_modal" table="table-role"/>
@endsection
