...
@section('modal-content')
    ...
    <div class="alert alert-primary" role="alert">
        Fungsi ini untuk membuat duplikat transaksi Financial Payment.
        <br>
    ...
    <dl class="row mb-0 redial-line-height-2_5">
        ...
        <dd class="col-sm-7">{{ $fields->PaymentID }}</dd>

        <dt class="col-sm-5">Payment Date:</dt>
        <dd class="col-sm-7">{{ date('d M Y',strtotime($fields->PaymentDate)) }}</dd>
