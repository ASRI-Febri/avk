...
@section('modal-content')
    ...
    <input type="hidden" id="IDX_T_ReceiveAllocation" name="IDX_T_ReceiveAllocation" value="{{ $fields->IDX_T_ReceiveAllocation }}"/>
    <input type="hidden" id="IDX_T_FinancialReceiveDetail" name="IDX_T_FinancialReceiveDetail" value="{{ $partnerid->IDX_T_FinancialReceiveDetail }}"/>
    ...
    <input type="hidden" id="IDX_M_Branch" name="IDX_M_Branch" value="{{ $partnerid->IDX_M_Branch }}"/>
    ...
    <x-textbox-horizontal label="Allocation Amount" id="AllocationAmount" :value="$fields->AllocationAmount" placeholder="(0.00)" class="required auto" />
