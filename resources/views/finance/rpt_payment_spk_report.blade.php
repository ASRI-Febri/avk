...
@section('content') 
    ...
    <?php
        ...
        if($records)
        {
            ...
            echo "<tr>\n";         
                echo "<th>NO</th>\n";                                
                echo "<th width=300 px>SPK DESCRIPTION</th>\n";     
                ...
                echo "<th width=90 px style=\"text-align:right;\">OS SPK - INV WITHOUT PPH</th>\n";
            echo "</tr>\n";
            echo "</thead>";
            echo "<tbody>";
            ...
            foreach ($records as $row):
                ...
                if($group1 <> $group2)
                {
                    ...
                    {   
                        ...
                        echo "<td class=\"$td_class text-right\">SPK AMOUNT :</td>";
            ...
            echo "<tr class=\"total\">\n";
                echo "<td class=\"$td_class\"></td>";
                echo "<td class=\"$td_class text-right\">GRAND TOTAL SPK AMOUNT :</td>";
