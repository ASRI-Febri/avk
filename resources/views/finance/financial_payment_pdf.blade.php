...
@section('content')    
    ...
    <div style="float:left;width:50%">
        ...
        <table class="noborder nopadding">
            <tr class="noborder nopadding">
                <td class="td-30 bold noborder nopadding param-key">Payment ID</td>
                <td class="td-50 bold noborder nopadding param-value">{{ $fields->PaymentID }}</td>
            </tr>
            <tr class="noborder nopadding">
                <td class="td-30 bold noborder nopadding param-key">No Voucher</td>
                <td class="td-50 bold noborder nopadding param-value">{{ $fields->VoucherNoManual }}</td>
            </tr>
            <tr class="noborder">
                <td class="td-30 bold noborder nopadding param-key">Tanggal Pengajuan</td>
                <td class="td-50 bold noborder nopadding param-value">{{ date('d M Y',strtotime($fields->PaymentDate)) }}</td>
            </tr>
            <tr class="noborder">
                <td class="td-30 bold noborder nopadding param-key">Tanggal Validasi</td>
                @php
                if ($fields->ValidationDate <> "")
                {
                    echo '<td class="td-50 bold noborder nopadding param-value">' . date('d M Y',strtotime($fields->ValidationDate)) . '</td>';
                }
                @endphp
            </tr>
        </table>
    ...
    <div>
        <table class="noborder nopadding">
            <tr class="noborder nopadding">
                ...
                <td class="td-50 bold noborder nopadding param-value">{{ $fields->FinancialAccountDesc }}</td>
                <td class="td-20 bold noborder nopadding param-key">Dibayar Kepada</td>
            ...
            <tr class="noborder nopadding">
                ...
                <td class="td-50 bold noborder nopadding param-value">{{ 'Rp. ' . number_format($fields->PaymentAmount, 2, '.', ',') }}</td>
                <td class="td-20 bold noborder nopadding param-key">No Cheque/BG</td>
                <td class="td-50 bold noborder nopadding param-value">{{ $fields->PDCNo }}</td>
            </tr>
            {{-- <tr class="noborder nopadding">
                <td class="td-20 bold noborder nopadding param-key">Terbilang</td>
                <td class="td-50 bold noborder nopadding param-value">{{ strtoupper($fields->AmountTerbilang) }}</td>
            </tr> --}}
        </table>
        <br>
        <table>
