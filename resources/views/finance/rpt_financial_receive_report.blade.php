    ...
    <?php
        ...
        if($records)
        {
            ...
            echo "<tr>\n";         
                ...
                echo "<th width=\"50\">RECEIVE DATE</th>\n";
                echo "<th width=\"100\">RECEIVE NO</th>\n";                                
            ...
            foreach ($records as $row):
                ...
                $total_amount += $row->ReceiveAmount;                               
                ...
                $group_total_amount += $row->ReceiveAmount;
                ...
                echo "<tr>\n";                
                    ...
                    */
                    ...
                    if($row->ReceiveDate !== NULL){
                        $receive_date = date('d M Y',strtotime($row->ReceiveDate));
                    }
                    
                    echo "<td class=\"$td_class text-center\">" .  $row->BranchID . "</td>\n"; 
                    echo "<td class=\"$td_class text-center\">" .  $receive_date . "</td>\n";    
                    //echo "<td class=\"$td_class\">" . $row->InvoiceNo . "</td>\n";  
                    echo "<td class=\"$td_class\">" . $row->ReceiveID . "</a></td>\n";                                      
                    echo "<td class=\"$td_class\">" . $row->FinancialAccountDesc . "</td>\n";		
                    echo "<td class=\"$td_class text-center\">" . $row->ReceiveStatusDesc . "</td>\n";
